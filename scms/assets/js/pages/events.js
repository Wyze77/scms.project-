                    ...
                    <div>
                        <div class="flex items-center justify-between text-sm mb-1">
                            <div class="flex items-center gap-1 text-text-secondary">
                                <i data-lucide="users" class="w-4 h-4"></i><span>Capacity</span>
                            </div>
  ...
  const content = `
    ...
    e.category
            ...
            <div class="space-y-3 text-text-primary">
                <div class="flex items-center gap-2"><i data-lucide="calendar" class="w-5 h-5 text-nav-primary"></i><span>${
                  e.date
                } at ${e.time}</span></div>
                <div class="flex items-center gap-2"><i data-lucide="map-pin" class="w-5 h-5 text-nav-primary"></i><span>${
                  e.location
                }</span></div>
                <div class="flex items-center gap-2"><i data-lucide="users" class="w-5 h-5 text-nav-primary"></i><span>${
                  e.registered
