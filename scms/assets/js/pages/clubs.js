      ...
      (c) => `
        ...
        c.category
                    ...
                    <div class="flex items-center gap-1 text-text-secondary text-sm">
                        <i data-lucide="users" class="w-4 h-4"></i><span>${
                          c.members
                        } members</span>
                    </div>
                </div>
                ...
                <div class="flex gap-2 pt-2">
                    ...
                    <button onclick="window.handleView(${
                      c.id
                    })" class="btn btn-secondary btn-sm"><i data-lucide="eye" class="w-4 h-4"></i></button>
                </div>
            </div>
        </div>`
    )
  ...
  const content = `
    ...
    c.category
                ...
                <div class="flex items-center gap-2 text-text-secondary">
                    <i data-lucide="users" class="w-5 h-5"></i><span>${
                      c.members
                    } members</span>
                </div>
            </div>
